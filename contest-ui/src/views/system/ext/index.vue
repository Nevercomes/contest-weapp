...
<script>
import { listExt, getExt, delExt, addExt, updateExt, exportExt } from "@/api/system/ext";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除用户扩展信息编号为"' + userIds + '"的数据项?', "警告", {
          confirmButtonText: "确定",
          cancelButtonText: "取消",
          type: "warning"
        }).then(function() {
          return delExt(userIds);
        }).then(() => {
          this.getList();

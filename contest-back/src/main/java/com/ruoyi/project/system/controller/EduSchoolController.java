...
public class EduSchoolController extends BaseController {
     ...
     * 获取学校信息详细信息
     */
    @PreAuthorize("@ss.hasPermi('system:school:options')")
    @GetMapping(value = "/options")
    public AjaxResult options(EduSchool eduSchool) {
        return AjaxResult.success(eduSchoolService.selectEduSchoolOptions(eduSchool));
    }
